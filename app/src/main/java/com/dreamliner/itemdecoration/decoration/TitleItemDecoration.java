package com.dreamliner.itemdecoration.decoration;
...
import com.dreamliner.itemdecoration.CityBean;
...
public class TitleItemDecoration extends RecyclerView.ItemDecoration {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (position != RecyclerView.NO_POSITION) {
                if (position == 0) {//等于0肯定要有title的
                    ...
                    if (null != mDatas.get(position).getTag() && !mDatas.get(position).getTag().equals(mDatas.get(position - 1)
                            .getTag())) {
    ...
    private void drawTitleArea(Canvas c, int left, int right, View child, RecyclerView.LayoutParams params, int position) {
        ...
        */
        ...
        c.drawText(mDatas.get(position).getTag(), child.getPaddingLeft(), child.getTop() - params.topMargin - (mTitleHeight / 2 -
